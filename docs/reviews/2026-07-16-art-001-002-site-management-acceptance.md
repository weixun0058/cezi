...
4. [x] 2026-07-18 已按 OPS-002 生成第一次真实文章卷备份，服务器侧文件大小与 SHA-256、归档完整性及服务恢复均通过；公开结论见 `docs/operations/2026-07-18-production-backup-acceptance.md`。

ART-001/002 的实现与生产部署均已成立；上述剩余动作属于写入链路和运维闭环验收，不再把系统描述为“待部署”。自 2026-07-18 起，ART-003 改为无固定篇数和期限的机会型内容运营项，不阻塞网站验收或其他工程任务；新文章仍不应只保存在尚无真实备份证据的生产卷中。
