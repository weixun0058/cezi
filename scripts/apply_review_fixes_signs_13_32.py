...
FIXES = [
    ...
    (15, "interpretation1", "Li Ge governs gradual change", "the Ge hexagram governs gradual change"),
    ...
    (22, "health", "governing the liver and tendons", "governing the liver, gallbladder, and tendons"),

    # ---- 第 23 签 ----
    # sign_text 整句：格式 2行→4行 + 人千里 语义修正
    (23, "sign_text",
     "Joy, joy, joy — the spring breeze gives birth to peach and plum.\n"
     "No need to force anxiety and worry; beneath the bright moon, one travels a thousand miles.",
     "Joy, joy, joy—\n"
...
def main():
    ...
    # 验证：扫描残留
    residuals = ["Li Ge", "thank the spring breeze", "drawn by destiny",
                 "one travels a thousand miles", "western tomb",
                 "liver and tendons"]
